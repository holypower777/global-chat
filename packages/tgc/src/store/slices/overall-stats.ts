...
// );
// export const getDailyStats = createSelector(getRootStats, (rootState) => rootState.dailyStats);
// export const getOverallStats = createSelector(getRootStats, (rootState) => rootState.stats);
// export const getOverallStatsPlots = createSelector(getRootStats, (rootState) => rootState.plots);
// const getOverallStatsTimes = createSelector(getOverallStatsPlots, (plots) =>
//     plots.map((e) => e.time!.getTime())
// );

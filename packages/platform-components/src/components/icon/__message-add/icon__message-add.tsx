...
const IconMessageAdd = (props: SingleIconProps) => (
    <Icon ico="message-add" {...props}>
        <svg data-testid="icon__message-add" viewBox="0 0 12 12">
            ...
            />
            <path
                d="M3.24487 8.73999H1.75488"
                strokeLinecap="round"
                strokeLinejoin="round"
                strokeMiterlimit="10"
            />
            <path
                d="M2.5 8.01001V9.505"
                strokeLinecap="round"
                strokeLinejoin="round"
                strokeMiterlimit="10"
            />

...
const IconCircleCross = (props: SingleIconProps) => (
    <Icon ico="circle-cross" {...props}>
        <svg data-testid="icon__circle-cross" viewBox="0 0 12 12">
            <path d="M6.99512 5.00502L7.41512 4.58502" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M4.58496 7.41498L5.95996 6.03998" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M7.41496 7.41502L4.58496 4.58502" strokeLinecap="round" strokeLinejoin="round" />

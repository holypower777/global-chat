...
const IconMessageRemove = (props: SingleIconProps) => (
    <Icon ico="message-remove" {...props}>
        <svg data-testid="icon__message-remove" viewBox="0 0 12 12">
            ...
            <path d="M3.0351 9.26996L1.9751 8.21497" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" />
            <path d="M3.02509 8.22998L1.96509 9.28497" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" />
            <path d="M4.25 5.25H7.75" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" />
            <path d="M11 5.76996V6.71497C11 7.46497 10.75 8.08997 10.31 8.52997C9.875 8.96497 9.25 9.21497 8.5 9.21497V10.28C8.5 10.68 8.05501 10.92 7.72501 10.7L5.5 9.21497H4.44C4.48 9.06497 4.5 8.90997 4.5 8.74997C4.5 8.23997 4.305 7.76998 3.985 7.41498C3.625 7.00498 3.09 6.74997 2.5 6.74997C1.94 6.74997 1.43 6.97998 1.065 7.35498C1.02 7.15498 1 6.93997 1 6.71497V3.71497C1 2.21497 2 1.21497 3.5 1.21497H8.5C10 1.21497 11 2.21497 11 3.71497" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" />
        </svg>
    </Icon>
);
